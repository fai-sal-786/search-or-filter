...
const price_value = document.getElementById("price");
const title_value = document.getElementById("name");
const renderData = (productData) => {
  console.log("data", productData);
  product_list.innerHTML = "";
  productData.forEach((data) => {
    const htmlContent = `<div class="p-4 md:w-1/3">
                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  ...
                  <div class="p-6">
                    ...
                    <h1 class="title-font text-lg font-medium text-gray-900 mb-3">$${data.price}</h1>
    ...
    product_list.innerHTML += htmlContent;
  });
};
renderData(products);
const filterByPrice = () => {
  ...
  const filteredProducts = products.filter(
    (data) => data.price < price_value.value
  );
...
const search = () => {
  const filteredProducts = products.filter((data) =>
    data.title.includes(title_value.value)
  );
  renderData(filteredProducts);
};
